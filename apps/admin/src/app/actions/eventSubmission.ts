    ...
    if (submission) {
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          thumbnail_link: submission.thumbnail_link,
          gallery_links: submission.gallery_links,
          additional_info_link: submission.additional_info_link,
          payment_type: submission.payment_type,
          ticket_links: submission.ticket_links,
          timezone: submission.timezone,
          has_registration: submission.has_registration,
          sponsors: submission.sponsors,
          event_scale: submission.event_scale,
