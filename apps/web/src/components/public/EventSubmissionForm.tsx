          ...
          {STEPS.map((stepName, idx) => {
            ...
            return (
              <div key={stepName} className="relative z-10 flex flex-col items-center gap-3">
                ...
                <div className={`absolute ${idx % 2 !== 0 ? 'bottom-10 sm:bottom-auto sm:top-14 flex-col-reverse sm:flex-col' : 'top-10 sm:top-14 flex-col'} left-1/2 -translate-x-1/2 w-36 text-center flex gap-0.5`}>
