        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {emergencyContacts.map((contact, idx) => (
            <a 
              ...
              className={`group bg-white border border-slate-100 rounded-[2px] p-8 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer shadow-[0_4px_20px_rgba(0,0,0,0.03)] ${contact.shadowHover} ${contact.bgHover}`}
            >
        ...
        <div className="bg-white rounded-[2px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative h-[400px] lg:h-auto w-full bg-slate-100">
              <iframe 
                src="https://maps.google.com/maps?q=Tourist%20Information%20Center%20Bandung&t=&z=16&ie=UTF8&iwloc=&output=embed" 
                width="100%" 
                height="100%" 
                style={{border:0}} 
