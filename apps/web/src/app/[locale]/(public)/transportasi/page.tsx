...
<ModernHero 
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 auto-rows-[minmax(160px,auto)] md:auto-rows-[300px]">
          ...
          <div className="bg-slate-900 h-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] group relative">
          ...
          <div className="md:col-span-2 bg-slate-900 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] group relative">
          ...
          <div className="lg:col-span-1 bg-slate-900 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-500 group relative">
          ...
          {/* Card 5: DAMRI & Angkot */}
          <div className="col-span-2 md:col-span-2 bg-white rounded-2xl p-5 md:p-10 border border-slate-100/80 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-500 relative overflow-hidden group">
